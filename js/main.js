...
// Create a base class called `Person` that takes the parameters `name`
...
// Create another class that extends the `Person` class called `Student`.
...
// Create another class that extends the `Person` class called `Teacher`.
...
setTeacher(){
  ...
  updateRoster(this);
    ...
    /////////////////////////////////////////
    // ADD `markAttendance()` method /////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////

    // Create a method to mark a student's attendance called `markAttendance()`.
...
let courseCode = prompt('Enter the course code:', 'WATS3020');
...
let courseDesctiption = prompt('Enter a descriptive summary of the course:', 'JavaScript is \
...
let myCourse = new Course(courseCode, courseTitle, courseDesctiption);
///////////////////////////////////////////////////
//////// Main Script /////////////////////////////
////////////////////////////////////////////////////////////////////////////////
